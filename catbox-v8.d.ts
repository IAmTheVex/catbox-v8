declare module "catbox-v8" {
	...
	export class Isolate {
		 ...
		 * reference handles created by catbox-v8 like Script or Context objects.
		 */
	...
	export class ExternalCopy<T> {
		...
		/**
		 * Static property which will return the total number of bytes that catbox-v8
