'use strict';
const catbox = require('catbox-v8');
...
const example = new catbox.NativeModule(require.resolve('.'));
...
// instance of `catbox.Reference` which is just the same object that you would get by doing
...
global.setSync('log', new catbox.Reference(function(...args) {
	console.log(...args);
}));
